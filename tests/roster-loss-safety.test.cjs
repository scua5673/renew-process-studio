...
function conflict(opts={}){
  ...
  vm.runInContext(['itemsResolveConflicts','itemsWriteOwner','itemsWriteCurrent','itemsObserveServer','itemsCreateAllowed','itemsDeletedLive','itemsDeleteReviews'].map(fn).join('\n'),h.c);
