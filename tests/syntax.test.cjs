...
for (const file of ['studio/storage.js', 'studio/scouting-store.js', 'studio/roster-recovery.js', 'studio/sync.js', 'studio/review-training.js', 'studio/review-training-schedule.js', 'studio/idp-evidence.js', 'studio/idp-recovery.js', 'studio/first-work.js', 'studio/session-focus.js', 'studio/daily-effort.js', 'sw.js']) {
