...
(function(root,factory){
  ...
  var DEFAULT_ENTRIES=[{
    id:'2026-09-17-board-grass-navy',date:'2026-09-17',title:'보드 배경을 잔디·네이비로 선택하세요',
    changes:[
      '새 보드는 잔디로 시작하고, 보드 설정에서 네이비 배경으로 바꿀 수 있습니다.',
      '새 페이지를 추가해도 선택한 배경을 유지합니다. 예전에 저장한 보드의 배경도 그대로 불러옵니다.'
    ]
  },{
