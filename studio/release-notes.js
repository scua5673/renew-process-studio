...
(function(root,factory){
  ...
  var DEFAULT_ENTRIES=[{
    ...
    changes:['입체 보기에서 연속된 이동 입력을 화면 갱신 주기에 맞춰 처리해 불필요한 반복 그리기를 줄였습니다.','운동장 모양이 같을 때 좌표 변환 계산을 재사용하고, 화면 크기·방향이 바뀌면 다시 계산합니다.','손을 놓는 순간의 최종 위치와 여러 토큰 이동·실행 취소를 유지합니다. 보드는 기존처럼 저장 버튼을 눌러 저장합니다.']
  },{
