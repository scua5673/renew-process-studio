...
(function(root,factory){
  ...
  var DEFAULT_ENTRIES=[{
    id:'2026-09-23-v2-887-board-page-animation',date:'2026-09-23',title:'v2.887 · 페이지별 작전판 애니메이션 복원을 바로잡았습니다',
    changes:['보드 안에서 페이지를 추가하고 각 페이지에 애니메이션을 만든 뒤 저장해도, 다시 열 때 최근 애니메이션만 남지 않도록 페이지별 장면을 복원합니다.','기존 단일 페이지 애니메이션 저장본은 이전처럼 열립니다.']
  },{
